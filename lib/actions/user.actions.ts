...
export async function getUserById(userId: string) {
  try {
    ...
    // FIX: The query was searching for a 'googleId' which is incorrect.
    // The session ID is the user's database '_id'.
    // I have changed this to search by the correct primary key.
